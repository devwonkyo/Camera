...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_CONTENT = "list_content";
    ...
    void addList(String content){
        ...
        if(result == -1){
            ...
            Toast.makeText(context, "Added Succesessfullly!", Toast.LENGTH_SHORT).show();
        }
    }
